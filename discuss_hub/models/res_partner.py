...
class ResPartner(models.Model):
    ...
    discuss_hub_channel_count = fields.Integer(
    ...
    def _compute_discuss_hub_count(self):
        for rec in self:
            ...
            rec.discuss_hub_channel_count = channels_data[0][0]
    ...
    def action_view_channel(self):
        ...
        action = self.env["ir.actions.act_window"]._for_xml_id(
            "discuss_hub.action_window_list_channels"
        )
        action["context"] = {}
        # if self.is_company:
    ...
    def get_or_create_discuss_hub_channel(self):
        """
