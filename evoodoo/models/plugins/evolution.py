...
class Plugin(PluginBase):
    ...
    def outgo_reaction(self, channel, message, reaction):
        ...
        name = channel.evoodoo_connector.name
    ...
    def send_text_message(self, channel, message):
        ...
        url = f"{self.connector.url}/message/sendText/{channel.evoodoo_connector.name}"
    ...
    def send_attachments(self, channel, message):
        ...
        url = f"{self.connector.url}/message/sendMedia/{channel.evoodoo_connector.name}"
